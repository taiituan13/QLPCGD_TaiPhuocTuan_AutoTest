    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            WebElement searchMajor = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div/div/div/div[2]/div/div/div[1]/div[2]/div/div[1]/div/label/input")));
             ...
             WebElement updateMajorButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div/div/div/div[2]/div/div/table/tbody/tr[1]/td[6]/a[1]/i")));
             updateMajorButton.click();
            ...
            updateButton.click();
            try {
                WebElement successPopup = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[3]/div/div")));
                if (successPopup.isDisplayed()) {
                    System.out.println("Chỉnh sữa thành công!");
                }
            } catch (Exception e) {
                System.out.println("Chỉnh sữa thất bại!");
            }
        } catch (Exception e) {
