...
public class CreateAcademicTitle {
        public static void main(String[] args) {
            ...
            try {
                ...
                WebElement CreateAcademictitleButton = wait.until(ExpectedConditions.visibilityOfElementLocated(
                        By.xpath(
                                "/html/body/div[2]/div[2]/div[3]/div/section/div/div/div/div[2]/div/div/div[1]/div[2]/div/div[2]/button/span")));
                CreateAcademictitleButton.click();
    
                // Enter major name and code
                WebElement AcademictitleId = wait.until(ExpectedConditions
                        .visibilityOfElementLocated(By.xpath("/html/body/div[3]/div[2]/form/div[1]/input")));
                AcademictitleId.sendKeys("0012");
    
                WebElement AcademictitleName = wait.until(ExpectedConditions
                        .visibilityOfElementLocated(By.xpath("/html/body/div[3]/div[2]/form/div[2]/input")));
                AcademictitleName.sendKeys("CNCdSATT");
    
                // Enter Term (if required)
                // 
    
                // // Enter Term (if required)
                // WebElement termField = driver.findElementWebElement majorabbreviation = wait.until(ExpectedConditions
                ...
                //         selectCurriculum.click();(By.id("term"));
                ...
                try {
                    ...
                    if (successPopup.isDisplayed()) {
                        System.out.println("Thêm học hàm thất bại!");
                    }
                } catch (Exception e) {
                    System.out.println("Thêm học hàm thành công!");
                }
            } catch (Exception e) {
