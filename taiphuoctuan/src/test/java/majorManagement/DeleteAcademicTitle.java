...
public class DeleteAcademicTitle {
        public static void main(String[] args) {
            ...
            try {
                ...
                WebElement DeleteAcademictitleButton = wait.until(ExpectedConditions.visibilityOfElementLocated(
                        By.xpath(
                                "/html/body/div[2]/div[2]/div[3]/div/section/div/div/div/div[2]/div/div/table/tbody/tr[1]/td[5]/a[2]/i")));
                DeleteAcademictitleButton.click();
                
                WebElement saveButton =  wait.until(ExpectedConditions
                .visibilityOfElementLocated(By.xpath("/html/body/div[3]/div/div[6]/button[1]")));
                saveButton.click();
                ...
                try {
                    ...
                    if (successPopup.isDisplayed()) {
                        System.out.println("Xóa học hàm thất bại!");
                    }
                } catch (Exception e) {
                    System.out.println("Xóa học hàm thành công!");
                }
            } catch (Exception e) {
